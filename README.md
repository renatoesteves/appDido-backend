# AppDido - Sistema Web e Mobile para Garçons

## Descrição
O **AppDido** é um sistema desenvolvido para auxiliar restaurantes no gerenciamento de pedidos e atendimento de mesas. Ele possui uma interface web para administração e um aplicativo mobile para os garçons, permitindo um serviço mais ágil e organizado.
...
1. Clone o repositório:
   ```sh
   git clone https://github.com/seuusuario/AppDido.git
